// readline treats CR as a delimiter and drops it; Git's bytes must reach their consumer unchanged, so
// records are split on exactly one byte and nothing else is interpreted.
