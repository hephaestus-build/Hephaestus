...
The SPA now uses [`cn`](https://github.com/shadcn-ui/cn) through its registry-configured styling entry
point instead of maintaining a `clsx` + `tailwind-merge` wrapper. The docs package's unused direct
