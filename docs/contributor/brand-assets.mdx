...
The README images capture the landing-page export stories, not just the static mark. Changes to
those stories, their component tree, or the shared theme also require regenerating the assets.
