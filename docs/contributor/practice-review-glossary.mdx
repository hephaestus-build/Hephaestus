...
| **Marked as addressed**  | The developer answered the feedback with *Addressed* or *Not applicable*. A dispute leaves it open. Whichever way resolved the feedback first is the one the card and the summary report.                                                                                                                                    | dismissed, acknowledged, done                       |
