...
| **Sandbox Gateway**                 | The single network address a sandbox may reach: the owning worker's one non-loopback listener, carrying model traffic, workspace download, result upload and mentor frames.                                                                | LLM proxy, git proxy, sandbox ingress                             |
