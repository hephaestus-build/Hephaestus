...
| **When evidence is insufficient**   | The required behavior when evidence requirements are not met. Every shipped contract version, `1.1.0` included, always skips automated review.                                                                                             | fallback, error handling                                          |
