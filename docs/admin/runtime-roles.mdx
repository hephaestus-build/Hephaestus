...
| `hephaestus.git.image` | `git-preparation:<app version>` tag | same | — | env default (`HEPHAESTUS_IMAGE_GIT_PREPARATION`); the shipped Compose files require the release lock's digest |
