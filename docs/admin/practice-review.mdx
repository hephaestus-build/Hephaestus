...
2. **The cooldown.** The minimum gap between reviews of the same pull or merge request. New commits
   are reviewed once the pushes stop for ten minutes, at the latest commit; a push inside the cooldown
   waits for it to end rather than going unreviewed.
