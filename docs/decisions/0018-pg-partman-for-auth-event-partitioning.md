...
- Changeset `1780825201546-18-auth-event-partman` (`1780825201546_changelog.xml`) is archived where
  [ADR 0014](0014-per-row-aes-gcm-aad-binding.md) § Update 2026-09-17 says; a fresh
