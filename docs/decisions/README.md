...
| [0002](0002-java-package-rename-to-aet-cit-tum.md) | Rename Java base package to `de.tum.cit.aet.hephaestus` | Accepted (amended 2026-09-17 — revisit trigger fired, package kept) |
...
| [0017](0017-replace-keycloak-with-spring-native-auth.md) | Replace Keycloak with Spring-native auth (BFF cookie-JWT + `Connection`-backed workspace IdPs) | Accepted (amended post-merge — Stage B-2 login model; 2026-09-17 — data-model split not fully executed) |
...
| [0020](0020-context-fabric-everything-is-an-integration.md) | Context Fabric — everything is an integration, only practice review and mentor are native | Accepted (amended 2026-08-04 #1430, 2026-08-30 #1636 — evidence storage superseded by [0039](0039-git-and-postgresql-own-evidence.md); 2026-09-03 #1719 — context mechanism superseded by [0041](0041-compose-1x-kubernetes-2.md); 2026-09-17 — shipped slice corrected, revisit trigger §9 fired) |
| [0021](0021-observations-feedback-synthesis-seam.md) | Separate observations from feedback | Accepted (amended 2026-07-31 #1423, 2026-08-16 #1430) |
...
| [0036](0036-agent-runtime-runs-on-node-24.md) | Agent runtime runs on Node.js 24 with bounded resources | Accepted (amended 2026-09-17 — the image installs the SDK with pnpm) |
