...
| # | Title | Status |
|---|---|---|
| [0001](0001-flat-top-level-layout.md) | Flat top-level layout | Accepted (amended 2026-09-17 — `server/` is a two-module Gradle root per [0032](0032-generated-clients-build-boundary.md)) |
| [0002](0002-java-package-rename-to-aet-cit-tum.md) | Rename Java base package to `de.tum.cit.aet.hephaestus` | Accepted (amended 2026-09-17 — deploy domain moved, package kept) |
| [0003](0003-spring-modulith-adoption.md) | Spring Modulith 2.0 adoption with two empirical shared kernels | Accepted (amended 2026-09-17 — kernel and named-interface names corrected) |
...
| [0005](0005-two-role-runtime-via-conditional-on-property.md) | Two-role runtime topology via `@ConditionalOnProperty` | Accepted (amended 2026-05-20 #1110 — webhook role wired; 2026-07-20 #1368 — proxy capability flag removed; 2026-07-21 #1368 — agent queue moved to PostgreSQL; 2026-07-22 #1368 — what the worker gate covers; 2026-08-22 — role-scoped settings gate; 2026-09-03 #1719 — role deferral superseded by [0041](0041-compose-1x-kubernetes-2.md)) |
| [0006](0006-llm-proxy-on-coordinator-trust-model.md) | LLM proxy stays on the coordinator (BYO trust model) | Accepted (amended 2026-07-20 #1368 — proxy follows the worker gate; 2026-07-28 #1400 — governed provider catalog; 2026-09-03 #1719 — Decision superseded by [0041](0041-compose-1x-kubernetes-2.md)) |
...
| [0008](0008-webhook-runtime-role.md) | Webhook as a third runtime role (`webhook-server` container) | Accepted (amended 2026-08-22 — webhook ingestion cannot fail silently; 2026-09-17 — receiver surface corrected) |
| [0009](0009-worker-runtime-substrate-wss-control-channel.md) | Worker runtime substrate + WSS-over-443 control channel | Accepted (amended 2026-07-21 #1368 — drain requeues in-flight jobs; 2026-09-03 #1719 — remote-worker premise superseded by [0041](0041-compose-1x-kubernetes-2.md); 2026-09-05 — frame type names corrected) |
| [0010](0010-outbound-oauth-state-handrolled.md) | Hand-roll OAuth state for outbound per-workspace integrations | Accepted (amended 2026-05-30 — PKCE primitive removed) |
| [0011](0011-integration-identity-not-wired-from-sync.md) | `integration_identity` is OAuth-fed, not sync-fed (tombstone) | Superseded by [0016](0016-unified-identity-keycloak-as-truth.md) |
| [0012](0012-cross-instance-identity-safety-on-sync-paths.md) | Cross-instance identity safety on sync paths | Accepted (amended 2026-09-17 — definitive-404 removal narrowed by [0024](0024-integration-sync-lifecycle-and-two-deletion-semantics.md)) |
| [0013](0013-no-jetstream-dlq-stream.md) | No dedicated JetStream DLQ stream — poison handler ACKs after N redeliveries | Accepted |
...
| [0021](0021-observations-feedback-synthesis-seam.md) | Separate observations from feedback | Accepted (amended 2026-07-31 #1423, 2026-08-18 #1444 — rewritten in place; refined by [0022](0022-observation-presence-assessment-and-schema-cleanup.md) and [0029](0029-measurement-intervention-seam-and-channel-levels.md)) |
| [0022](0022-observation-presence-assessment-and-schema-cleanup.md) | Observation = presence × assessment (drop `Practice.kind`); reaction anchors on feedback; ruthless column cleanup | Accepted (observation semantics amended before 1.0; 2026-09-17 — channel value corrected) |
| [0023](0023-outline-documentation-integration.md) | Outline documentation integration — a content source, not a detection surface | Accepted (amended 2026-08-08 — a document is a reviewable artifact) |
| [0024](0024-integration-sync-lifecycle-and-two-deletion-semantics.md) | Integration sync lifecycle — drift tombstones and mirror erasure are two different operations | Accepted (amended 2026-09-03 #1404 — who may read a tombstoned row; 2026-09-04 #1806 — re-offered signals are held; 2026-09-05 #1825 — live occasions take the same hold; 2026-09-05 #1404 — capture and the non-SCM kinds; 2026-09-17 — Outline resubmitter recorded) |
...
| [0029](0029-measurement-intervention-seam-and-channel-levels.md) | Separate measurement from intervention and derive level from channel | Accepted (amended 2026-09-17 — `basedOn` names this run's observations only) |
...
| [0032](0032-generated-clients-build-boundary.md) | Generated clients have an independent build boundary | Ownership boundary accepted; Maven mechanism superseded by [0043](0043-gradle-java-build.md) |
...
| [0034](0034-signed-release-image-lock.md) | Production consumes one signed release image lock | Accepted (amended 2026-09-03 #1719 — 2.0 lock inventory from [0041](0041-compose-1x-kubernetes-2.md); 2026-09-05 — operator toolchain superseded by [0037](0037-node-24-and-pnpm-12-are-the-javascript-toolchain.md)) |
| [0035](0035-pull-request-previews-are-label-gated.md) | Pull request previews are label-gated and driven from the default branch | Accepted (amended 2026-09-03 #1719 — agent execution host superseded by [0041](0041-compose-1x-kubernetes-2.md); 2026-09-17 — previews only for pull requests targeting `main`, and the concurrency groups) |
| [0036](0036-agent-runtime-runs-on-node-24.md) | Agent runtime runs on Node.js 24 with bounded resources | Accepted (amended 2026-09-17 — the image installs the SDK with pnpm). Supersedes [0030](0030-agent-runtime-is-typescript-on-bun.md) for the sandbox image. Repository tooling is governed by [0037](0037-node-24-and-pnpm-12-are-the-javascript-toolchain.md), which superseded [0033](0033-bun-is-the-javascript-runtime-and-package-manager.md). |
| [0037](0037-node-24-and-pnpm-12-are-the-javascript-toolchain.md) | Node.js 24 and pnpm 12 are the JavaScript toolchain | Accepted (amended 2026-09-03 — [0040](0040-vite-plus-is-the-command-surface.md) makes Vite+ the command surface; 2026-09-17 — the pins have moved) |
| [0038](0038-postgresql-18-release-baseline.md) | PostgreSQL 18 is the only supported major version | Accepted |
| [0039](0039-git-and-postgresql-own-evidence.md) | Git owns repository evidence; PostgreSQL owns captured payloads and references | Accepted (amended 2026-09-03 #1719 — publication, durability and materialization superseded by [0041](0041-compose-1x-kubernetes-2.md)) |
| [0040](0040-vite-plus-is-the-command-surface.md) | Vite+ is the command surface; pnpm stays the package manager | Accepted (amended 2026-09-17 — how `prepare` enables the hooks) |
