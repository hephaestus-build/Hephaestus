...
choosing a provider. Setup then takes two steps. Step 1 shows the data notice, which also carries the
terms of use, and asks you to accept them. **Accepting is not consent to research.**

Step 2 asks separately about research: **Yes, I'll take part** for the research described in the
notice, or **Continue without research** for the same service without opting in. Neither is selected
for you, both are one click, and you can go back to the notice or sign out before answering. Change
your decision later in [User settings](#your-choices-and-right-to-object).
