...
## Your workspace AI choice

[Your AI choice](./workspace#your-ai-choice) is the loosest way of handling your work that you accept,
separately for each workspace: only in-house; in-house or a provider that keeps nothing after the
reply; any AI the workspace set up, including a provider that keeps it for a limited time for safety
checks; or no AI. Anything stricter than your answer also counts, and nothing switches you to anything
looser. This choice is distinct from research participation and from linking an account. A workspace
owner declares how each model handles data; ask them about the actual provider and agreement.
