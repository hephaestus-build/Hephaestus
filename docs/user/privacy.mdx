...
**Yes, take part** for the research described in the notice, or **No, don't take part** for the same
service without opting in. Neither is selected for you, and both cost the same click. **Continue**
records both decisions together, against the version of the notice you were shown. Change your
research answer later in [User settings](#your-choices-and-right-to-object).
...
- **Academic research participation:** where offered, use **User settings → Academic research participation →
  Participate in academic research** to record or withdraw your agreement. Withdrawal does not stop
  ordinary practice reviews or erase stored data. Contact your instance's privacy contact about data
  already shared for research and withdrawal from a specific study.
