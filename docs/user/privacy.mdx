...
only in-house; in-house or a provider that keeps nothing after the reply; any AI a workspace set up,
including a provider that keeps it for a limited time for safety checks; or no AI. You answer once,
and your answer applies in all your workspaces on this deployment; change it from **Your AI choice**
in any workspace's sidebar or in **User settings**. Anything stricter than your answer also counts,
nothing switches you to anything looser, and a workspace adding models never asks you again. This
choice is distinct from research participation and from linking an account. A workspace owner
declares how each model handles data; ask them about the actual provider and agreement.
