...
- **Academic research participation:** where offered, use **User settings → Academic research participation →
  ...
  Withdrawal does not stop ordinary practice reviews or erase stored data. Contact your instance's
  privacy contact about data already shared for research and withdrawal from a specific study.
