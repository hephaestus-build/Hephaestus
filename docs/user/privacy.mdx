...
The first is the data notice, which also carries the terms of use, and a box to accept them.
**Accepting is not consent to research.** The second asks about research participation:
**Yes, take part** for the research the notice describes, run by the organisation the notice names, or
**No, don't take part** for the same service without opting in. Neither is selected for you, and both
cost the same click. **Continue** records both decisions together, against the version of the notice
you were shown. You can change the research answer later; see
