...
[Workspace preferences](./workspace#your-first-visit-and-ai-preferences) let you choose On-premises,
Private cloud, or No AI separately for each workspace. This choice is distinct from research
participation and from linking an account. A workspace owner declares each model's processing
location; ask them about the actual provider and data-handling arrangements.
