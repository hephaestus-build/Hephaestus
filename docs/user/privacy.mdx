...
When you request workspace access, Hephaestus records your submitted details, linked-account references
and the exact workspace notices you acknowledge. Workspace administrators review the application; other
applicants cannot see it. Notification email links back to Hephaestus and does not include your submitted
comments.

Your account export includes your own submissions and acknowledged notices. Account erasure removes
those submissions and their email-delivery records. A workspace may also set a retention period for
completed applications. Cleanup waits for active access, unresolved applications and external access
removal to finish. It does not delete your shared account, change optional research consent or erase
separately retained audit history.
