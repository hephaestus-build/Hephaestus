...
The first is **Terms and privacy**: three short points — use Hephaestus lawfully, treat its feedback as
advisory, and read the privacy notice for who runs your instance and what it stores — and a box to
accept the terms. Accepting them is not consent to research.
