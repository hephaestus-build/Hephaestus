...
You can read your instance's privacy notice before choosing a sign-in provider. During setup, review
the data notice and accept the terms of use. **Acknowledging the privacy notice does not consent to research.**

A separate step offers **Yes, I'll take part** for the research described in the notice, or **Continue
without research** for the same service without opting in. Neither is selected for you. You can return
to the notice or sign out before submitting. Change your decision later in
[User settings](#your-choices-and-right-to-object).
