...
silently returning to the workspace home. In Slack, a member who chose No AI, or who still has to
make a required choice, gets a reply saying so, and Heph no longer starts a conversation or shows
that it is reviewing their feedback. Instance admins can still administer a workspace they are not
a member of, but no longer get Heph there.
