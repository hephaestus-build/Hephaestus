...
class PracticeDetectionDeliveryServiceTest extends BaseUnitTest {
    ...
    void shouldAdmitExactIndentedQuoteWithServerLineSemantics(String quote) {
        ...
        assertThat(publishVerified(testJob, List.of(observation)).inserted()).isEqualTo(1);
    ...
    @ParameterizedTest
    @ValueSource(strings = {"Trivio:  # TODO: Adjust Name", " \t\n"})
    void shouldRejectMissingIndentationAndBlankQuotes(String quote) {
        capturedDiff = ("--- a/src/Auth.java\n+++ b/src/Auth.java\n@@ -10 +10 @@\n"
                + "[L10] +  Trivio:  # TODO: Adjust Name\n");
        var observation = validObservation("pr-description-quality", Presence.PRESENT);
