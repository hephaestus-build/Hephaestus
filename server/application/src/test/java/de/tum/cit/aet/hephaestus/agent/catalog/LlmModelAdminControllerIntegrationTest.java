...
class LlmModelAdminControllerIntegrationTest extends AbstractWorkspaceIntegrationTest {
    ...
    void appAdminCanCreateGetListUpdateAndDeleteAModel() {
        ...
        var updateRequest = new UpdateLlmModelRequestDTO("Renamed Model", null, null, null, null, null, null);
        webTestClient
                .patch()
                .uri("/admin/llm/models/{id}", created.id())
                .headers(h -> h.setBearerAuth(ADMIN_TOKEN))
    ...
    void appAdminDeclaresDataHandlingAndTheTierIsDerivedOnEveryRead() {
        ...
        webTestClient
                ...
                .headers(h -> h.setBearerAuth(ADMIN_TOKEN))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UpdateLlmModelRequestDTO(null, null, null, null, null, null, null))
                .exchange()
                .expectStatus()
                .isOk()
                .expectBody()
    ...
    void activatingADeclaredModelWithItsDeclarationKeepsTheTier() {
        ...
        webTestClient
                ...
                .bodyValue(new UpdateLlmModelRequestDTO(
                        null, null, null, null, LlmDataOperator.OWN_ORGANISATION, null, true))
                .exchange()
                .expectStatus()
                .isOk()
                .expectBody(Void.class);
