...
class GitHubAccessMigrationLiquibaseTest {
    ...
    private static String target(int id, int workspace, int connection, long organization, long scope) {
        return """
            INSERT INTO github_access_target(id,workspace_id,connection_id,directory_provider_id,registration_id,issuer,status,
            ...
            VALUES (%d,%d,%d,100,'organization','https://identity.example.com/realms/team','DRAFT','example-org',500,%d,%d,true,false,1,0,'[]','[]')
