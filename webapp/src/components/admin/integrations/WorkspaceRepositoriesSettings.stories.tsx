...
import { WorkspaceRepositoriesSettings } from "./WorkspaceRepositoriesSettings";

const meta = {
	component: WorkspaceRepositoriesSettings,
...
} satisfies Meta<typeof WorkspaceRepositoriesSettings>;
