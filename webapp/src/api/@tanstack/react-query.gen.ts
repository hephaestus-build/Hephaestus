...
import { addLabelFilter, addLabelToTeam, addRepositoryToMonitor, adminApproveDirectoryGroups, adminCreateCuratedGroup, adminCreateCuratedPractice, adminCreateLlmConnection, adminCreateLlmModel, adminCreateLoginProvider, adminCreateProductSurvey, adminDeleteCuratedGroupOverride, adminDeleteCuratedPracticeOverride, adminDeleteLlmConnection, adminDeleteLlmModel, adminDeleteLoginProvider, adminExportAuthEvents, adminGetConfigurationReadiness, adminGetCuratedCatalog, adminGetCuratedGroup, adminGetCuratedPractice, adminGetInstanceSettings, adminGetLlmConnection, adminGetLlmModel, adminGetLlmSettings, adminGetLlmUsageReport, adminGetPracticeDefinitionOptions, adminKeepCuratedGroup, adminKeepCuratedPractice, adminListAuthEvents, adminListConfigAuditEvents, adminListLlmConnections, adminListLlmModels, adminListLoginProviders, adminListProductFeedback, adminListProductSurveyResponses, adminListProductSurveys, adminListUsers, adminListWorkspaces, adminPlaceCuratedPractice, adminProbeLlmConnection, adminProbeLlmConnectionDraft, adminReorderCuratedGroups, adminReorderCuratedPractices, adminResetCuratedCatalogOrder, adminRevokeUserSessions, adminUpdateCuratedGroup, adminUpdateCuratedGroupStatus, adminUpdateCuratedPractice, adminUpdateCuratedPracticeStatus, adminUpdateLlmConnection, adminUpdateLlmModel, adminUpdateLlmModelPrice, adminUpdateLlmModelSharing, adminUpdateLlmSettings, adminUpdateLoginProvider, adminUpdateSilentMode, adminUpdateUser, adminUpdateWorkspaceLlmBudget, adoptDirectoryMember, adoptGroup, adoptPractice, approveDirectoryPolicy, approveGitHubAccessTarget, assignRole, audit, authorizeGitHubAccessHandoff, autonomyRollup, bindGroup, callbackGet, callbackPost, cancelAgentJob, changeDirectoryPolicyStatus, changeMyGitHubAccessEnrollment, checkWorkspaceOrganizationMembership, completeFirstLoginConsent, computeUserLeagueStats, configureAgent, configureDirectoryPolicy, configureGitHubAccessTarget, configureWorkspaceAccessPolicy, createGitHubAccessTarget, createGroup, createPractice, createSweepSchedule, createWorkspace, decideFeedbackProposal, decideGitHubAccessMembership, deleteAgent, deleteCurrentUser, deleteFeedbackResponse, deleteGroup, deleteOutlineCollection, deletePractice, deleteSweepSchedule, deleteThread, dismissProductSurvey, downloadDataExport, endGitHubAccessTarget, exitImpersonation, getActivityMonitor, getAgentJob, getAllTeams, getArtifactTrace, getBackfillRun, getConnectionSyncStatus, getConsentStatus, getCuratedPracticeCatalogEntry, getCurrentUser, getCurrentUserMembership, getDataExportStatus, getDirectoryPolicy, getDirectorySources, getFeedbackProposalDecision, getFeedbackResolutionCounts, getFeedbackResponse, getGitHubAccessTargets, getGroup, getInAppFeedback, getIntegrationCatalog, getJwks, getLabelFilters, getLeaderboard, getLlmUsageReport, getMember, getMyGitHubAccess, getMyWorkspaceAccessRequests, getObservation, getObservationsForPullRequest, getOutlineCollection, getOutlineTokenStatus, getPractice, getPracticeDefinitionOptions, getPracticeGroupTrend, getPracticeReviewFeedback, getPracticeReviewObservation, getPracticeReviewSettings, getProviders, getRepositoriesToMonitor, getRepositorySettings, getSlackUserPreferences, getSummary, getTeamSettings, getThread, getUserFeatures, getUserProfile, getUserSettings, getUsersWithTeams, getWorkspace, getWorkspaceAccessEntry, getWorkspaceAccessForm, getWorkspaceAccessNotifications, getWorkspaceAccessOffers, getWorkspaceAccessPolicy, getWorkspaceAccessRequests, getWorkspaceAccessReviewOptions, gitLabPreflight, impersonate, initiate, joinDirectoryWorkspace, list, listAccountIdentityProviders, listAdoptablePractices, listAgentJobs, listAgents, listAvailableProductSurveys, listBackfillRuns, listConnectionSyncJobs, listConnectionSyncResources, listGitLabGroups, listGlobalContributors, listGroups, listIdentityProviders, listLinkedIdentities, listMembers, listObservations, listOutlineCollectionCandidates, listOutlineCollections, listPracticeEvidenceOutcomes, listPracticeGroupReviewRuns, listPracticeGroupStandings, listPracticeReviewFeedback, listPracticeReviewObservations, listPracticeReviews, listPractices, listPracticeStandings, listReviewedPractices, listSessions, listSlackChannelCandidates, listSlackChannelConsentEvents, listSlackChannels, listSweepSchedules, listThreads, listTracedArtifacts, listWorkspaceConfigAuditEvents, listWorkspaceContributors, listWorkspaces, logout, type Options, pauseGitHubAccessTarget, placePractice, preflightBackfillRun, previewCoverage, previewDirectoryPolicy, previewGitHubAccessHandoff, previewGitHubAccessTarget, previewGroupAdoption, previewPracticeAdoption, purgeWorkspace, read, reconcileDirectoryPolicy, reconcileGitHubAccessTarget, refresh, registerOutlineCollection, registerSlackChannel, removeLabelFilter, removeLabelFromTeam, removeMember, removeRepositoryToMonitor, removeVote, renameSlug, renewGitHubAccessHandoff, reorderGroups, reorderPractices, replaceFeedbackResponse, replaceSweepSchedule, requestDataExport, requestPracticeReview, resetAndRecalculateLeagues, retryAgentJobDelivery, retryWorkspaceAccessNotification, reviewWorkspaceAccessRequest, revokeOtherSessions, revokeSession, sendSlackTestMessage, setAutonomy, setGroupAutonomy, submitInstanceProductFeedback, submitProductSurveyResponse, submitWorkspaceAccessRequest, submitWorkspaceProductFeedback, triggerSyncJob, unlinkIdentity, updateBackfillRunStatus, updateConnectionStatus, updateConnectionSyncJob, updateFeatures, updateGroup, updateLeaderboardDigest, updateMemberVisibility, updateNotifications, updateOutlineCollectionState, updatePractice, updatePracticeReviewSettings, updatePublicVisibility, updateRepositorySettings, updateRepositoryVisibility, updateResearchConsent, updateSchedule, updateSlackChannelConsent, updateSlackUserPreferences, updateStatus, updateTeamSettings, updateTeamVisibility, updateToken, updateUserSettings, updateWorkspaceLlmBudget, vote, withdrawWorkspaceAccessRequest, workspaceCreateLlmConnection, workspaceCreateLlmModel, workspaceDeleteLlmConnection, workspaceDeleteLlmModel, workspaceGetLlmConnection, workspaceGetLlmModel, workspaceGetLlmSettings, workspaceListAvailableLlmModels, workspaceListLlmConnections, workspaceListLlmModels, workspaceProbeLlmConnection, workspaceUpdateLlmConnection, workspaceUpdateLlmModel } from '../sdk.gen.js';
import type { AddLabelFilterData, AddLabelToTeamData, AddLabelToTeamResponse, AddRepositoryToMonitorData, AdminApproveDirectoryGroupsData, AdminApproveDirectoryGroupsResponse, AdminCreateCuratedGroupData, AdminCreateCuratedGroupError, AdminCreateCuratedGroupResponse, AdminCreateCuratedPracticeData, AdminCreateCuratedPracticeError, AdminCreateCuratedPracticeResponse, AdminCreateLlmConnectionData, AdminCreateLlmConnectionResponse, AdminCreateLlmModelData, AdminCreateLlmModelResponse, AdminCreateLoginProviderData, AdminCreateLoginProviderResponse, AdminCreateProductSurveyData, AdminCreateProductSurveyResponse, AdminDeleteCuratedGroupOverrideData, AdminDeleteCuratedGroupOverrideError, AdminDeleteCuratedGroupOverrideResponse, AdminDeleteCuratedPracticeOverrideData, AdminDeleteCuratedPracticeOverrideError, AdminDeleteCuratedPracticeOverrideResponse, AdminDeleteLlmConnectionData, AdminDeleteLlmConnectionResponse, AdminDeleteLlmModelData, AdminDeleteLlmModelResponse, AdminDeleteLoginProviderData, AdminExportAuthEventsData, AdminExportAuthEventsResponse, AdminGetConfigurationReadinessData, AdminGetConfigurationReadinessResponse, AdminGetCuratedCatalogData, AdminGetCuratedCatalogResponse, AdminGetCuratedGroupData, AdminGetCuratedGroupResponse, AdminGetCuratedPracticeData, AdminGetCuratedPracticeResponse, AdminGetInstanceSettingsData, AdminGetInstanceSettingsResponse, AdminGetLlmConnectionData, AdminGetLlmConnectionResponse, AdminGetLlmModelData, AdminGetLlmModelResponse, AdminGetLlmSettingsData, AdminGetLlmSettingsResponse, AdminGetLlmUsageReportData, AdminGetLlmUsageReportResponse, AdminGetPracticeDefinitionOptionsData, AdminGetPracticeDefinitionOptionsResponse, AdminKeepCuratedGroupData, AdminKeepCuratedGroupError, AdminKeepCuratedGroupResponse, AdminKeepCuratedPracticeData, AdminKeepCuratedPracticeError, AdminKeepCuratedPracticeResponse, AdminListAuthEventsData, AdminListAuthEventsResponse, AdminListConfigAuditEventsData, AdminListConfigAuditEventsResponse, AdminListLlmConnectionsData, AdminListLlmConnectionsResponse, AdminListLlmModelsData, AdminListLlmModelsResponse, AdminListLoginProvidersData, AdminListLoginProvidersResponse, AdminListProductFeedbackData, AdminListProductFeedbackResponse, AdminListProductSurveyResponsesData, AdminListProductSurveyResponsesResponse, AdminListProductSurveysData, AdminListProductSurveysResponse, AdminListUsersData, AdminListUsersResponse, AdminListWorkspacesData, AdminListWorkspacesResponse, AdminPlaceCuratedPracticeData, AdminPlaceCuratedPracticeResponse, AdminProbeLlmConnectionData, AdminProbeLlmConnectionDraftData, AdminProbeLlmConnectionDraftResponse, AdminProbeLlmConnectionResponse, AdminReorderCuratedGroupsData, AdminReorderCuratedGroupsResponse, AdminReorderCuratedPracticesData, AdminReorderCuratedPracticesResponse, AdminResetCuratedCatalogOrderData, AdminResetCuratedCatalogOrderResponse, AdminRevokeUserSessionsData, AdminRevokeUserSessionsResponse, AdminUpdateCuratedGroupData, AdminUpdateCuratedGroupError, AdminUpdateCuratedGroupResponse, AdminUpdateCuratedGroupStatusData, AdminUpdateCuratedGroupStatusError, AdminUpdateCuratedGroupStatusResponse, AdminUpdateCuratedPracticeData, AdminUpdateCuratedPracticeError, AdminUpdateCuratedPracticeResponse, AdminUpdateCuratedPracticeStatusData, AdminUpdateCuratedPracticeStatusError, AdminUpdateCuratedPracticeStatusResponse, AdminUpdateLlmConnectionData, AdminUpdateLlmConnectionResponse, AdminUpdateLlmModelData, AdminUpdateLlmModelPriceData, AdminUpdateLlmModelPriceResponse, AdminUpdateLlmModelResponse, AdminUpdateLlmModelSharingData, AdminUpdateLlmModelSharingResponse, AdminUpdateLlmSettingsData, AdminUpdateLlmSettingsResponse, AdminUpdateLoginProviderData, AdminUpdateLoginProviderResponse, AdminUpdateSilentModeData, AdminUpdateSilentModeError, AdminUpdateSilentModeResponse, AdminUpdateUserData, AdminUpdateUserResponse, AdminUpdateWorkspaceLlmBudgetData, AdminUpdateWorkspaceLlmBudgetResponse, AdoptDirectoryMemberData, AdoptDirectoryMemberResponse, AdoptGroupData, AdoptGroupResponse, AdoptPracticeData, AdoptPracticeError, AdoptPracticeResponse, ApproveDirectoryPolicyData, ApproveDirectoryPolicyResponse, ApproveGitHubAccessTargetData, ApproveGitHubAccessTargetResponse, AssignRoleData, AssignRoleResponse, AuditData, AuditResponse, AuthorizeGitHubAccessHandoffData, AuthorizeGitHubAccessHandoffResponse, AutonomyRollupData, AutonomyRollupResponse, BindGroupData, BindGroupError, BindGroupResponse, CallbackGetData, CallbackGetResponse, CallbackPostData, CallbackPostResponse, CancelAgentJobData, CancelAgentJobResponse, ChangeDirectoryPolicyStatusData, ChangeDirectoryPolicyStatusResponse, ChangeMyGitHubAccessEnrollmentData, ChangeMyGitHubAccessEnrollmentResponse, CheckWorkspaceOrganizationMembershipData, CheckWorkspaceOrganizationMembershipResponse, CompleteFirstLoginConsentData, CompleteFirstLoginConsentResponse, ComputeUserLeagueStatsData, ComputeUserLeagueStatsResponse, ConfigureAgentData, ConfigureAgentResponse, ConfigureDirectoryPolicyData, ConfigureDirectoryPolicyResponse, ConfigureGitHubAccessTargetData, ConfigureGitHubAccessTargetResponse, ConfigureWorkspaceAccessPolicyData, ConfigureWorkspaceAccessPolicyResponse, CreateGitHubAccessTargetData, CreateGitHubAccessTargetResponse, CreateGroupData, CreateGroupResponse, CreatePracticeData, CreatePracticeError, CreatePracticeResponse, CreateSweepScheduleData, CreateSweepScheduleError, CreateSweepScheduleResponse, CreateWorkspaceData, CreateWorkspaceResponse, DecideFeedbackProposalData, DecideFeedbackProposalResponse, DecideGitHubAccessMembershipData, DecideGitHubAccessMembershipResponse, DeleteAgentData, DeleteAgentResponse, DeleteCurrentUserData, DeleteFeedbackResponseData, DeleteFeedbackResponseResponse, DeleteGroupData, DeleteGroupResponse, DeleteOutlineCollectionData, DeleteOutlineCollectionResponse, DeletePracticeData, DeletePracticeError, DeletePracticeResponse, DeleteSweepScheduleData, DeleteSweepScheduleError, DeleteSweepScheduleResponse, DeleteThreadData, DeleteThreadResponse, DismissProductSurveyData, DownloadDataExportData, DownloadDataExportResponse, EndGitHubAccessTargetData, EndGitHubAccessTargetResponse, ExitImpersonationData, GetActivityMonitorData, GetActivityMonitorResponse, GetAgentJobData, GetAgentJobResponse, GetAllTeamsData, GetAllTeamsResponse, GetArtifactTraceData, GetArtifactTraceError, GetArtifactTraceResponse, GetBackfillRunData, GetBackfillRunError, GetBackfillRunResponse, GetConnectionSyncStatusData, GetConnectionSyncStatusResponse, GetConsentStatusData, GetConsentStatusResponse, GetCuratedPracticeCatalogEntryData, GetCuratedPracticeCatalogEntryResponse, GetCurrentUserData, GetCurrentUserMembershipData, GetCurrentUserMembershipResponse, GetCurrentUserResponse, GetDataExportStatusData, GetDataExportStatusResponse, GetDirectoryPolicyData, GetDirectoryPolicyResponse, GetDirectorySourcesData, GetDirectorySourcesResponse, GetFeedbackProposalDecisionData, GetFeedbackProposalDecisionResponse, GetFeedbackResolutionCountsData, GetFeedbackResolutionCountsResponse, GetFeedbackResponseData, GetFeedbackResponseResponse, GetGitHubAccessTargetsData, GetGitHubAccessTargetsResponse, GetGroupData, GetGroupResponse, GetInAppFeedbackData, GetInAppFeedbackResponse, GetIntegrationCatalogData, GetIntegrationCatalogResponse, GetJwksData, GetJwksResponse, GetLabelFiltersData, GetLabelFiltersResponse, GetLeaderboardData, GetLeaderboardResponse, GetLlmUsageReportData, GetLlmUsageReportResponse, GetMemberData, GetMemberResponse, GetMyGitHubAccessData, GetMyGitHubAccessResponse, GetMyWorkspaceAccessRequestsData, GetMyWorkspaceAccessRequestsResponse, GetObservationData, GetObservationResponse, GetObservationsForPullRequestData, GetObservationsForPullRequestResponse, GetOutlineCollectionData, GetOutlineCollectionResponse, GetOutlineTokenStatusData, GetOutlineTokenStatusResponse, GetPracticeData, GetPracticeDefinitionOptionsData, GetPracticeDefinitionOptionsResponse, GetPracticeError, GetPracticeGroupTrendData, GetPracticeGroupTrendResponse, GetPracticeResponse, GetPracticeReviewFeedbackData, GetPracticeReviewFeedbackError, GetPracticeReviewFeedbackResponse, GetPracticeReviewObservationData, GetPracticeReviewObservationError, GetPracticeReviewObservationResponse, GetPracticeReviewSettingsData, GetPracticeReviewSettingsResponse, GetProvidersData, GetProvidersResponse, GetRepositoriesToMonitorData, GetRepositoriesToMonitorResponse, GetRepositorySettingsData, GetRepositorySettingsResponse, GetSlackUserPreferencesData, GetSlackUserPreferencesResponse, GetSummaryData, GetSummaryResponse, GetTeamSettingsData, GetTeamSettingsResponse, GetThreadData, GetThreadResponse, GetUserFeaturesData, GetUserFeaturesResponse, GetUserProfileData, GetUserProfileResponse, GetUserSettingsData, GetUserSettingsResponse, GetUsersWithTeamsData, GetUsersWithTeamsResponse, GetWorkspaceAccessEntryData, GetWorkspaceAccessEntryResponse, GetWorkspaceAccessFormData, GetWorkspaceAccessFormResponse, GetWorkspaceAccessNotificationsData, GetWorkspaceAccessNotificationsResponse, GetWorkspaceAccessOffersData, GetWorkspaceAccessOffersResponse, GetWorkspaceAccessPolicyData, GetWorkspaceAccessPolicyResponse, GetWorkspaceAccessRequestsData, GetWorkspaceAccessRequestsResponse, GetWorkspaceAccessReviewOptionsData, GetWorkspaceAccessReviewOptionsResponse, GetWorkspaceData, GetWorkspaceResponse, GitLabPreflightData, GitLabPreflightResponse2, ImpersonateData, InitiateData, InitiateResponse, JoinDirectoryWorkspaceData, JoinDirectoryWorkspaceResponse, ListAccountIdentityProvidersData, ListAccountIdentityProvidersResponse, ListAdoptablePracticesData, ListAdoptablePracticesError, ListAdoptablePracticesResponse, ListAgentJobsData, ListAgentJobsResponse, ListAgentsData, ListAgentsResponse, ListAvailableProductSurveysData, ListAvailableProductSurveysResponse, ListBackfillRunsData, ListBackfillRunsResponse, ListConnectionSyncJobsData, ListConnectionSyncJobsResponse, ListConnectionSyncResourcesData, ListConnectionSyncResourcesResponse, ListData, ListGitLabGroupsData, ListGitLabGroupsResponse, ListGlobalContributorsData, ListGlobalContributorsResponse, ListGroupsData, ListGroupsResponse, ListIdentityProvidersData, ListIdentityProvidersResponse, ListLinkedIdentitiesData, ListLinkedIdentitiesResponse, ListMembersData, ListMembersResponse, ListObservationsData, ListObservationsResponse, ListOutlineCollectionCandidatesData, ListOutlineCollectionCandidatesResponse, ListOutlineCollectionsData, ListOutlineCollectionsResponse, ListPracticeEvidenceOutcomesData, ListPracticeEvidenceOutcomesResponse, ListPracticeGroupReviewRunsData, ListPracticeGroupReviewRunsError, ListPracticeGroupReviewRunsResponse, ListPracticeGroupStandingsData, ListPracticeGroupStandingsResponse, ListPracticeReviewFeedbackData, ListPracticeReviewFeedbackError, ListPracticeReviewFeedbackResponse, ListPracticeReviewObservationsData, ListPracticeReviewObservationsError, ListPracticeReviewObservationsResponse, ListPracticeReviewsData, ListPracticeReviewsError, ListPracticeReviewsResponse, ListPracticesData, ListPracticesResponse, ListPracticeStandingsData, ListPracticeStandingsResponse, ListResponse, ListReviewedPracticesData, ListReviewedPracticesResponse, ListSessionsData, ListSessionsResponse, ListSlackChannelCandidatesData, ListSlackChannelCandidatesResponse, ListSlackChannelConsentEventsData, ListSlackChannelConsentEventsResponse, ListSlackChannelsData, ListSlackChannelsResponse, ListSweepSchedulesData, ListSweepSchedulesResponse, ListThreadsData, ListThreadsResponse, ListTracedArtifactsData, ListTracedArtifactsError, ListTracedArtifactsResponse, ListWorkspaceConfigAuditEventsData, ListWorkspaceConfigAuditEventsResponse, ListWorkspaceContributorsData, ListWorkspaceContributorsResponse, ListWorkspacesData, ListWorkspacesResponse, LogoutData, PauseGitHubAccessTargetData, PauseGitHubAccessTargetResponse, PlacePracticeData, PlacePracticeError, PlacePracticeResponse, PreflightBackfillRunData, PreflightBackfillRunError, PreflightBackfillRunResponse, PreviewCoverageData, PreviewCoverageResponse, PreviewDirectoryPolicyData, PreviewDirectoryPolicyResponse, PreviewGitHubAccessHandoffData, PreviewGitHubAccessHandoffResponse, PreviewGitHubAccessTargetData, PreviewGitHubAccessTargetResponse, PreviewGroupAdoptionData, PreviewGroupAdoptionResponse, PreviewPracticeAdoptionData, PreviewPracticeAdoptionError, PreviewPracticeAdoptionResponse, PurgeWorkspaceData, PurgeWorkspaceResponse, ReadData, ReadResponse, ReconcileDirectoryPolicyData, ReconcileDirectoryPolicyResponse, ReconcileGitHubAccessTargetData, ReconcileGitHubAccessTargetResponse, RefreshData, RefreshResponse, RegisterOutlineCollectionData, RegisterOutlineCollectionResponse, RegisterSlackChannelData, RegisterSlackChannelResponse, RemoveLabelFilterData, RemoveLabelFilterResponse, RemoveLabelFromTeamData, RemoveLabelFromTeamResponse, RemoveMemberData, RemoveMemberResponse, RemoveRepositoryToMonitorData, RemoveVoteData, RemoveVoteResponse, RenameSlugData, RenameSlugResponse, RenewGitHubAccessHandoffData, RenewGitHubAccessHandoffResponse, ReorderGroupsData, ReorderGroupsResponse, ReorderPracticesData, ReorderPracticesError, ReorderPracticesResponse, ReplaceFeedbackResponseData, ReplaceFeedbackResponseResponse, ReplaceSweepScheduleData, ReplaceSweepScheduleError, ReplaceSweepScheduleResponse, RequestDataExportData, RequestDataExportResponse, RequestPracticeReviewData, RequestPracticeReviewError, RequestPracticeReviewResponse, ResetAndRecalculateLeaguesData, RetryAgentJobDeliveryData, RetryAgentJobDeliveryResponse, RetryWorkspaceAccessNotificationData, RetryWorkspaceAccessNotificationResponse, ReviewWorkspaceAccessRequestData, ReviewWorkspaceAccessRequestResponse, RevokeOtherSessionsData, RevokeSessionData, SendSlackTestMessageData, SendSlackTestMessageResponse, SetAutonomyData, SetAutonomyError, SetAutonomyResponse, SetGroupAutonomyData, SetGroupAutonomyResponse, SubmitInstanceProductFeedbackData, SubmitProductSurveyResponseData, SubmitWorkspaceAccessRequestData, SubmitWorkspaceAccessRequestResponse, SubmitWorkspaceProductFeedbackData, TriggerSyncJobData, TriggerSyncJobError, TriggerSyncJobResponse, UnlinkIdentityData, UnlinkIdentityResponse, UpdateBackfillRunStatusData, UpdateBackfillRunStatusError, UpdateBackfillRunStatusResponse, UpdateConnectionStatusData, UpdateConnectionStatusResponse, UpdateConnectionSyncJobData, UpdateConnectionSyncJobError, UpdateConnectionSyncJobResponse, UpdateFeaturesData, UpdateFeaturesResponse, UpdateGroupData, UpdateGroupResponse, UpdateLeaderboardDigestData, UpdateLeaderboardDigestResponse, UpdateMemberVisibilityData, UpdateMemberVisibilityResponse, UpdateNotificationsData, UpdateNotificationsResponse, UpdateOutlineCollectionStateData, UpdateOutlineCollectionStateResponse, UpdatePracticeData, UpdatePracticeError, UpdatePracticeResponse, UpdatePracticeReviewSettingsData, UpdatePracticeReviewSettingsResponse, UpdatePublicVisibilityData, UpdatePublicVisibilityResponse, UpdateRepositorySettingsData, UpdateRepositorySettingsError, UpdateRepositorySettingsResponse, UpdateRepositoryVisibilityData, UpdateResearchConsentData, UpdateResearchConsentResponse, UpdateScheduleData, UpdateScheduleResponse, UpdateSlackChannelConsentData, UpdateSlackChannelConsentResponse, UpdateSlackUserPreferencesData, UpdateSlackUserPreferencesResponse, UpdateStatusData, UpdateStatusResponse, UpdateTeamSettingsData, UpdateTeamSettingsError, UpdateTeamSettingsResponse, UpdateTeamVisibilityData, UpdateTokenData, UpdateTokenResponse, UpdateUserSettingsData, UpdateUserSettingsResponse, UpdateWorkspaceLlmBudgetData, UpdateWorkspaceLlmBudgetResponse, VoteData, VoteResponse, WithdrawWorkspaceAccessRequestData, WithdrawWorkspaceAccessRequestResponse, WorkspaceCreateLlmConnectionData, WorkspaceCreateLlmConnectionResponse, WorkspaceCreateLlmModelData, WorkspaceCreateLlmModelResponse, WorkspaceDeleteLlmConnectionData, WorkspaceDeleteLlmConnectionResponse, WorkspaceDeleteLlmModelData, WorkspaceDeleteLlmModelResponse, WorkspaceGetLlmConnectionData, WorkspaceGetLlmConnectionResponse, WorkspaceGetLlmModelData, WorkspaceGetLlmModelResponse, WorkspaceGetLlmSettingsData, WorkspaceGetLlmSettingsResponse, WorkspaceListAvailableLlmModelsData, WorkspaceListAvailableLlmModelsResponse, WorkspaceListLlmConnectionsData, WorkspaceListLlmConnectionsResponse, WorkspaceListLlmModelsData, WorkspaceListLlmModelsResponse, WorkspaceProbeLlmConnectionData, WorkspaceProbeLlmConnectionResponse, WorkspaceUpdateLlmConnectionData, WorkspaceUpdateLlmConnectionResponse, WorkspaceUpdateLlmModelData, WorkspaceUpdateLlmModelResponse } from '../types.gen.js';
...
/**
 * Approve Keycloak directory eligibility groups
 */
export const adminApproveDirectoryGroupsMutation = (options?: Partial<Options<AdminApproveDirectoryGroupsData>>): UseMutationOptions<AdminApproveDirectoryGroupsResponse, DefaultError, Options<AdminApproveDirectoryGroupsData>> => {
  const mutationOptions: UseMutationOptions<AdminApproveDirectoryGroupsResponse, DefaultError, Options<AdminApproveDirectoryGroupsData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await adminApproveDirectoryGroups({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
export const adminListProductSurveyResponsesQueryKey = (options?: Options<AdminListProductSurveyResponsesData>) => createQueryKey('adminListProductSurveyResponses', options, false, ['feedback-admin']);
...
export const adminListProductSurveysQueryKey = (options?: Options<AdminListProductSurveysData>) => createQueryKey('adminListProductSurveys', options, false, ['feedback-admin']);
...
export const getMyGitHubAccessQueryKey = (options?: Options<GetMyGitHubAccessData>) => createQueryKey('getMyGitHubAccess', options, false, ['account-git-hub-access']);

/**
 * Inspect your GitHub invitations, managed memberships and pending removals
 */
export const getMyGitHubAccessOptions = (options?: Options<GetMyGitHubAccessData>) => queryOptions<GetMyGitHubAccessResponse, DefaultError, GetMyGitHubAccessResponse, ReturnType<typeof getMyGitHubAccessQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getMyGitHubAccess({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getMyGitHubAccessQueryKey(options)
});

/**
 * Authorize a bound GitHub scope using your verified organization-owner identity
 */
export const authorizeGitHubAccessHandoffMutation = (options?: Partial<Options<AuthorizeGitHubAccessHandoffData>>): UseMutationOptions<AuthorizeGitHubAccessHandoffResponse, DefaultError, Options<AuthorizeGitHubAccessHandoffData>> => {
  const mutationOptions: UseMutationOptions<AuthorizeGitHubAccessHandoffResponse, DefaultError, Options<AuthorizeGitHubAccessHandoffData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await authorizeGitHubAccessHandoff({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Inspect the workspace and target requesting your organization-owner approval
 */
export const previewGitHubAccessHandoffMutation = (options?: Partial<Options<PreviewGitHubAccessHandoffData>>): UseMutationOptions<PreviewGitHubAccessHandoffResponse, DefaultError, Options<PreviewGitHubAccessHandoffData>> => {
  const mutationOptions: UseMutationOptions<PreviewGitHubAccessHandoffResponse, DefaultError, Options<PreviewGitHubAccessHandoffData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await previewGitHubAccessHandoff({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Leave or rejoin your offered target without expanding approved eligibility
 */
export const changeMyGitHubAccessEnrollmentMutation = (options?: Partial<Options<ChangeMyGitHubAccessEnrollmentData>>): UseMutationOptions<ChangeMyGitHubAccessEnrollmentResponse, DefaultError, Options<ChangeMyGitHubAccessEnrollmentData>> => {
  const mutationOptions: UseMutationOptions<ChangeMyGitHubAccessEnrollmentResponse, DefaultError, Options<ChangeMyGitHubAccessEnrollmentData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await changeMyGitHubAccessEnrollment({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
export const listAccountIdentityProvidersQueryKey = (options?: Options<ListAccountIdentityProvidersData>) => createQueryKey('listAccountIdentityProviders', options, false, ['Auth discovery']);

/**
 * List configured providers for account linking and reauthentication
 */
export const listAccountIdentityProvidersOptions = (options?: Options<ListAccountIdentityProvidersData>) => queryOptions<ListAccountIdentityProvidersResponse, DefaultError, ListAccountIdentityProvidersResponse, ReturnType<typeof listAccountIdentityProvidersQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await listAccountIdentityProviders({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: listAccountIdentityProvidersQueryKey(options)
});
...
export const getWorkspaceAccessOffersQueryKey = (options?: Options<GetWorkspaceAccessOffersData>) => createQueryKey('getWorkspaceAccessOffers', options, false, ['account-workspace-access']);

/**
 * List workspace offers from your verified organizational identity
 */
export const getWorkspaceAccessOffersOptions = (options?: Options<GetWorkspaceAccessOffersData>) => queryOptions<GetWorkspaceAccessOffersResponse, DefaultError, GetWorkspaceAccessOffersResponse, ReturnType<typeof getWorkspaceAccessOffersQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getWorkspaceAccessOffers({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getWorkspaceAccessOffersQueryKey(options)
});

/**
 * Join a workspace using your current directory eligibility
 */
export const joinDirectoryWorkspaceMutation = (options?: Partial<Options<JoinDirectoryWorkspaceData>>): UseMutationOptions<JoinDirectoryWorkspaceResponse, DefaultError, Options<JoinDirectoryWorkspaceData>> => {
  const mutationOptions: UseMutationOptions<JoinDirectoryWorkspaceResponse, DefaultError, Options<JoinDirectoryWorkspaceData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await joinDirectoryWorkspace({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
export const getWorkspaceAccessEntryQueryKey = (options: Options<GetWorkspaceAccessEntryData>) => createQueryKey('getWorkspaceAccessEntry', options, false, ['workspace-access']);

/**
 * Discover this workspace's primary sign-in option
 */
export const getWorkspaceAccessEntryOptions = (options: Options<GetWorkspaceAccessEntryData>) => queryOptions<GetWorkspaceAccessEntryResponse, DefaultError, GetWorkspaceAccessEntryResponse, ReturnType<typeof getWorkspaceAccessEntryQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getWorkspaceAccessEntry({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getWorkspaceAccessEntryQueryKey(options)
});

/**
 * Retry an undelivered access notification
 */
export const retryWorkspaceAccessNotificationMutation = (options?: Partial<Options<RetryWorkspaceAccessNotificationData>>): UseMutationOptions<RetryWorkspaceAccessNotificationResponse, DefaultError, Options<RetryWorkspaceAccessNotificationData>> => {
  const mutationOptions: UseMutationOptions<RetryWorkspaceAccessNotificationResponse, DefaultError, Options<RetryWorkspaceAccessNotificationData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await retryWorkspaceAccessNotification({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
export const getWorkspaceAccessPolicyQueryKey = (options: Options<GetWorkspaceAccessPolicyData>) => createQueryKey('getWorkspaceAccessPolicy', options, false, ['workspace-access']);

/**
 * Inspect access-request configuration
 */
export const getWorkspaceAccessPolicyOptions = (options: Options<GetWorkspaceAccessPolicyData>) => queryOptions<GetWorkspaceAccessPolicyResponse, DefaultError, GetWorkspaceAccessPolicyResponse, ReturnType<typeof getWorkspaceAccessPolicyQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getWorkspaceAccessPolicy({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getWorkspaceAccessPolicyQueryKey(options)
});

/**
 * Configure, pause or resume workspace access requests
 */
export const configureWorkspaceAccessPolicyMutation = (options?: Partial<Options<ConfigureWorkspaceAccessPolicyData>>): UseMutationOptions<ConfigureWorkspaceAccessPolicyResponse, DefaultError, Options<ConfigureWorkspaceAccessPolicyData>> => {
  const mutationOptions: UseMutationOptions<ConfigureWorkspaceAccessPolicyResponse, DefaultError, Options<ConfigureWorkspaceAccessPolicyData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await configureWorkspaceAccessPolicy({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
export const getWorkspaceAccessRequestsQueryKey = (options: Options<GetWorkspaceAccessRequestsData>) => createQueryKey('getWorkspaceAccessRequests', options, false, ['workspace-access']);

/**
 * Review workspace access requests
 */
export const getWorkspaceAccessRequestsOptions = (options: Options<GetWorkspaceAccessRequestsData>) => queryOptions<GetWorkspaceAccessRequestsResponse, DefaultError, GetWorkspaceAccessRequestsResponse, ReturnType<typeof getWorkspaceAccessRequestsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getWorkspaceAccessRequests({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getWorkspaceAccessRequestsQueryKey(options)
});

export const getWorkspaceAccessRequestsInfiniteQueryKey = (options: Options<GetWorkspaceAccessRequestsData>): QueryKey<Options<GetWorkspaceAccessRequestsData>> => createQueryKey('getWorkspaceAccessRequests', options, true);

/**
 * Review workspace access requests
 */
export const getWorkspaceAccessRequestsInfiniteOptions = (options: Options<GetWorkspaceAccessRequestsData>) => {
  const opts = infiniteQueryOptions<GetWorkspaceAccessRequestsResponse, DefaultError, InfiniteData<GetWorkspaceAccessRequestsResponse>, QueryKey<Options<GetWorkspaceAccessRequestsData>>, number | Pick<QueryKey<Options<GetWorkspaceAccessRequestsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
      const page: Pick<QueryKey<Options<GetWorkspaceAccessRequestsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
        query: {
          page: pageParam
        }
      };
    ...
    queryKey: getWorkspaceAccessRequestsInfiniteQueryKey(options)
  });
  return opts as Omit<typeof opts, 'initialData'>;
};

export const getMyWorkspaceAccessRequestsQueryKey = (options: Options<GetMyWorkspaceAccessRequestsData>) => createQueryKey('getMyWorkspaceAccessRequests', options, false, ['workspace-access']);

/**
 * Read your own access requests, including after expiry
 */
export const getMyWorkspaceAccessRequestsOptions = (options: Options<GetMyWorkspaceAccessRequestsData>) => queryOptions<GetMyWorkspaceAccessRequestsResponse, DefaultError, GetMyWorkspaceAccessRequestsResponse, ReturnType<typeof getMyWorkspaceAccessRequestsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getMyWorkspaceAccessRequests({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getMyWorkspaceAccessRequestsQueryKey(options)
});

/**
 * Submit an acknowledged access request or renewal
 */
export const submitWorkspaceAccessRequestMutation = (options?: Partial<Options<SubmitWorkspaceAccessRequestData>>): UseMutationOptions<SubmitWorkspaceAccessRequestResponse, DefaultError, Options<SubmitWorkspaceAccessRequestData>> => {
  const mutationOptions: UseMutationOptions<SubmitWorkspaceAccessRequestResponse, DefaultError, Options<SubmitWorkspaceAccessRequestData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await submitWorkspaceAccessRequest({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Admit an existing organization member using fresh provider-native proof
 */
export const checkWorkspaceOrganizationMembershipMutation = (options?: Partial<Options<CheckWorkspaceOrganizationMembershipData>>): UseMutationOptions<CheckWorkspaceOrganizationMembershipResponse, DefaultError, Options<CheckWorkspaceOrganizationMembershipData>> => {
  const mutationOptions: UseMutationOptions<CheckWorkspaceOrganizationMembershipResponse, DefaultError, Options<CheckWorkspaceOrganizationMembershipData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await checkWorkspaceOrganizationMembership({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
export const getWorkspaceAccessFormQueryKey = (options: Options<GetWorkspaceAccessFormData>) => createQueryKey('getWorkspaceAccessForm', options, false, ['workspace-access']);

/**
 * Read the current access form after proving the primary identity
 */
export const getWorkspaceAccessFormOptions = (options: Options<GetWorkspaceAccessFormData>) => queryOptions<GetWorkspaceAccessFormResponse, DefaultError, GetWorkspaceAccessFormResponse, ReturnType<typeof getWorkspaceAccessFormQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getWorkspaceAccessForm({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getWorkspaceAccessFormQueryKey(options)
});

/**
 * Withdraw your undecided request without changing existing access
 */
export const withdrawWorkspaceAccessRequestMutation = (options?: Partial<Options<WithdrawWorkspaceAccessRequestData>>): UseMutationOptions<WithdrawWorkspaceAccessRequestResponse, DefaultError, Options<WithdrawWorkspaceAccessRequestData>> => {
  const mutationOptions: UseMutationOptions<WithdrawWorkspaceAccessRequestResponse, DefaultError, Options<WithdrawWorkspaceAccessRequestData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await withdrawWorkspaceAccessRequest({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
export const getWorkspaceAccessReviewOptionsQueryKey = (options: Options<GetWorkspaceAccessReviewOptionsData>) => createQueryKey('getWorkspaceAccessReviewOptions', options, false, ['workspace-access']);

/**
 * List currently eligible maintainers and teams for access review
 */
export const getWorkspaceAccessReviewOptionsOptions = (options: Options<GetWorkspaceAccessReviewOptionsData>) => queryOptions<GetWorkspaceAccessReviewOptionsResponse, DefaultError, GetWorkspaceAccessReviewOptionsResponse, ReturnType<typeof getWorkspaceAccessReviewOptionsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getWorkspaceAccessReviewOptions({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getWorkspaceAccessReviewOptionsQueryKey(options)
});

/**
 * Approve, request changes or reject someone else's request
 */
export const reviewWorkspaceAccessRequestMutation = (options?: Partial<Options<ReviewWorkspaceAccessRequestData>>): UseMutationOptions<ReviewWorkspaceAccessRequestResponse, DefaultError, Options<ReviewWorkspaceAccessRequestData>> => {
  const mutationOptions: UseMutationOptions<ReviewWorkspaceAccessRequestResponse, DefaultError, Options<ReviewWorkspaceAccessRequestData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await reviewWorkspaceAccessRequest({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
export const getWorkspaceAccessNotificationsQueryKey = (options: Options<GetWorkspaceAccessNotificationsData>) => createQueryKey('getWorkspaceAccessNotifications', options, false, ['workspace-access']);

/**
 * Inspect access email delivery without exposing addresses
 */
export const getWorkspaceAccessNotificationsOptions = (options: Options<GetWorkspaceAccessNotificationsData>) => queryOptions<GetWorkspaceAccessNotificationsResponse, DefaultError, GetWorkspaceAccessNotificationsResponse, ReturnType<typeof getWorkspaceAccessNotificationsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getWorkspaceAccessNotifications({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getWorkspaceAccessNotificationsQueryKey(options)
});
...
export const listWorkspaceContributorsQueryKey = (options: Options<ListWorkspaceContributorsData>) => createQueryKey('listWorkspaceContributors', options, false, ['workspace-contributor']);

export const listWorkspaceContributorsOptions = (options: Options<ListWorkspaceContributorsData>) => queryOptions<ListWorkspaceContributorsResponse, DefaultError, ListWorkspaceContributorsResponse, ReturnType<typeof listWorkspaceContributorsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await listWorkspaceContributors({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: listWorkspaceContributorsQueryKey(options)
});

export const listWorkspaceContributorsInfiniteQueryKey = (options: Options<ListWorkspaceContributorsData>): QueryKey<Options<ListWorkspaceContributorsData>> => createQueryKey('listWorkspaceContributors', options, true);

export const listWorkspaceContributorsInfiniteOptions = (options: Options<ListWorkspaceContributorsData>) => {
  const opts = infiniteQueryOptions<ListWorkspaceContributorsResponse, DefaultError, InfiniteData<ListWorkspaceContributorsResponse>, QueryKey<Options<ListWorkspaceContributorsData>>, number | Pick<QueryKey<Options<ListWorkspaceContributorsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
      const page: Pick<QueryKey<Options<ListWorkspaceContributorsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
        query: {
          page: pageParam
        }
      };
    ...
    queryKey: listWorkspaceContributorsInfiniteQueryKey(options)
  });
  return opts as Omit<typeof opts, 'initialData'>;
};
...
export const getDirectoryPolicyQueryKey = (options: Options<GetDirectoryPolicyData>) => createQueryKey('getDirectoryPolicy', options, false, ['directory-policy']);

/**
 * Inspect workspace directory management and its evidence
 */
export const getDirectoryPolicyOptions = (options: Options<GetDirectoryPolicyData>) => queryOptions<GetDirectoryPolicyResponse, DefaultError, GetDirectoryPolicyResponse, ReturnType<typeof getDirectoryPolicyQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getDirectoryPolicy({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getDirectoryPolicyQueryKey(options)
});

/**
 * Save directory setup or revise its draft groups and credentials
 */
export const configureDirectoryPolicyMutation = (options?: Partial<Options<ConfigureDirectoryPolicyData>>): UseMutationOptions<ConfigureDirectoryPolicyResponse, DefaultError, Options<ConfigureDirectoryPolicyData>> => {
  const mutationOptions: UseMutationOptions<ConfigureDirectoryPolicyResponse, DefaultError, Options<ConfigureDirectoryPolicyData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await configureDirectoryPolicy({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Approve one fresh configuration preview
 */
export const approveDirectoryPolicyMutation = (options?: Partial<Options<ApproveDirectoryPolicyData>>): UseMutationOptions<ApproveDirectoryPolicyResponse, DefaultError, Options<ApproveDirectoryPolicyData>> => {
  const mutationOptions: UseMutationOptions<ApproveDirectoryPolicyResponse, DefaultError, Options<ApproveDirectoryPolicyData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await approveDirectoryPolicy({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Explicitly adopt existing non-owner access into directory management
 */
export const adoptDirectoryMemberMutation = (options?: Partial<Options<AdoptDirectoryMemberData>>): UseMutationOptions<AdoptDirectoryMemberResponse, DefaultError, Options<AdoptDirectoryMemberData>> => {
  const mutationOptions: UseMutationOptions<AdoptDirectoryMemberResponse, DefaultError, Options<AdoptDirectoryMemberData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await adoptDirectoryMember({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Capture a complete preview without changing access
 */
export const previewDirectoryPolicyMutation = (options?: Partial<Options<PreviewDirectoryPolicyData>>): UseMutationOptions<PreviewDirectoryPolicyResponse, DefaultError, Options<PreviewDirectoryPolicyData>> => {
  const mutationOptions: UseMutationOptions<PreviewDirectoryPolicyResponse, DefaultError, Options<PreviewDirectoryPolicyData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await previewDirectoryPolicy({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Reconcile the owner-approved directory policy
 */
export const reconcileDirectoryPolicyMutation = (options?: Partial<Options<ReconcileDirectoryPolicyData>>): UseMutationOptions<ReconcileDirectoryPolicyResponse, DefaultError, Options<ReconcileDirectoryPolicyData>> => {
  const mutationOptions: UseMutationOptions<ReconcileDirectoryPolicyResponse, DefaultError, Options<ReconcileDirectoryPolicyData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await reconcileDirectoryPolicy({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
export const getDirectorySourcesQueryKey = (options: Options<GetDirectorySourcesData>) => createQueryKey('getDirectorySources', options, false, ['directory-policy']);

/**
 * List operator-approved directory sources
 */
export const getDirectorySourcesOptions = (options: Options<GetDirectorySourcesData>) => queryOptions<GetDirectorySourcesResponse, DefaultError, GetDirectorySourcesResponse, ReturnType<typeof getDirectorySourcesQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getDirectorySources({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getDirectorySourcesQueryKey(options)
});

/**
 * Pause, resume or end directory management
 */
export const changeDirectoryPolicyStatusMutation = (options?: Partial<Options<ChangeDirectoryPolicyStatusData>>): UseMutationOptions<ChangeDirectoryPolicyStatusResponse, DefaultError, Options<ChangeDirectoryPolicyStatusData>> => {
  const mutationOptions: UseMutationOptions<ChangeDirectoryPolicyStatusResponse, DefaultError, Options<ChangeDirectoryPolicyStatusData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await changeDirectoryPolicyStatus({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
export const getGitHubAccessTargetsQueryKey = (options: Options<GetGitHubAccessTargetsData>) => createQueryKey('getGitHubAccessTargets', options, false, ['git-hub-access']);

/**
 * Inspect independent GitHub organization and team access targets
 */
export const getGitHubAccessTargetsOptions = (options: Options<GetGitHubAccessTargetsData>) => queryOptions<GetGitHubAccessTargetsResponse, DefaultError, GetGitHubAccessTargetsResponse, ReturnType<typeof getGitHubAccessTargetsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getGitHubAccessTargets({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getGitHubAccessTargetsQueryKey(options)
});

/**
 * Draft a target and issue a one-use organization-owner handoff
 */
export const createGitHubAccessTargetMutation = (options?: Partial<Options<CreateGitHubAccessTargetData>>): UseMutationOptions<CreateGitHubAccessTargetResponse, DefaultError, Options<CreateGitHubAccessTargetData>> => {
  const mutationOptions: UseMutationOptions<CreateGitHubAccessTargetResponse, DefaultError, Options<CreateGitHubAccessTargetData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await createGitHubAccessTarget({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * End management while retaining authority and credentials until removals are confirmed
 */
export const endGitHubAccessTargetMutation = (options?: Partial<Options<EndGitHubAccessTargetData>>): UseMutationOptions<EndGitHubAccessTargetResponse, DefaultError, Options<EndGitHubAccessTargetData>> => {
  const mutationOptions: UseMutationOptions<EndGitHubAccessTargetResponse, DefaultError, Options<EndGitHubAccessTargetData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await endGitHubAccessTarget({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Revise the target policy and require fresh organization-owner authorization
 */
export const configureGitHubAccessTargetMutation = (options?: Partial<Options<ConfigureGitHubAccessTargetData>>): UseMutationOptions<ConfigureGitHubAccessTargetResponse, DefaultError, Options<ConfigureGitHubAccessTargetData>> => {
  const mutationOptions: UseMutationOptions<ConfigureGitHubAccessTargetResponse, DefaultError, Options<ConfigureGitHubAccessTargetData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await configureGitHubAccessTarget({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Approve the exact fresh preview under current workspace ownership
 */
export const approveGitHubAccessTargetMutation = (options?: Partial<Options<ApproveGitHubAccessTargetData>>): UseMutationOptions<ApproveGitHubAccessTargetResponse, DefaultError, Options<ApproveGitHubAccessTargetData>> => {
  const mutationOptions: UseMutationOptions<ApproveGitHubAccessTargetResponse, DefaultError, Options<ApproveGitHubAccessTargetData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await approveGitHubAccessTarget({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Restore owner authorization or a reinstalled Access App without dropping pending removals
 */
export const renewGitHubAccessHandoffMutation = (options?: Partial<Options<RenewGitHubAccessHandoffData>>): UseMutationOptions<RenewGitHubAccessHandoffResponse, DefaultError, Options<RenewGitHubAccessHandoffData>> => {
  const mutationOptions: UseMutationOptions<RenewGitHubAccessHandoffResponse, DefaultError, Options<RenewGitHubAccessHandoffData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await renewGitHubAccessHandoff({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Adopt freshly inspected access, retain a manual exception or reset an exception
 */
export const decideGitHubAccessMembershipMutation = (options?: Partial<Options<DecideGitHubAccessMembershipData>>): UseMutationOptions<DecideGitHubAccessMembershipResponse, DefaultError, Options<DecideGitHubAccessMembershipData>> => {
  const mutationOptions: UseMutationOptions<DecideGitHubAccessMembershipResponse, DefaultError, Options<DecideGitHubAccessMembershipData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await decideGitHubAccessMembership({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Pause or resume writes without claiming access was revoked
 */
export const pauseGitHubAccessTargetMutation = (options?: Partial<Options<PauseGitHubAccessTargetData>>): UseMutationOptions<PauseGitHubAccessTargetResponse, DefaultError, Options<PauseGitHubAccessTargetData>> => {
  const mutationOptions: UseMutationOptions<PauseGitHubAccessTargetResponse, DefaultError, Options<PauseGitHubAccessTargetData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await pauseGitHubAccessTarget({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Inventory existing access and current eligibility without provider writes
 */
export const previewGitHubAccessTargetMutation = (options?: Partial<Options<PreviewGitHubAccessTargetData>>): UseMutationOptions<PreviewGitHubAccessTargetResponse, DefaultError, Options<PreviewGitHubAccessTargetData>> => {
  const mutationOptions: UseMutationOptions<PreviewGitHubAccessTargetResponse, DefaultError, Options<PreviewGitHubAccessTargetData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await previewGitHubAccessTarget({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Reconcile approved access and read back pending actions
 */
export const reconcileGitHubAccessTargetMutation = (options?: Partial<Options<ReconcileGitHubAccessTargetData>>): UseMutationOptions<ReconcileGitHubAccessTargetResponse, DefaultError, Options<ReconcileGitHubAccessTargetData>> => {
  const mutationOptions: UseMutationOptions<ReconcileGitHubAccessTargetResponse, DefaultError, Options<ReconcileGitHubAccessTargetData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await reconcileGitHubAccessTarget({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
export const listAvailableProductSurveysQueryKey = (options: Options<ListAvailableProductSurveysData>) => createQueryKey('listAvailableProductSurveys', options, false, ['feedback']);

/**
 * List surveys not yet handled by the current account
 */
export const listAvailableProductSurveysOptions = (options: Options<ListAvailableProductSurveysData>) => queryOptions<ListAvailableProductSurveysResponse, DefaultError, ListAvailableProductSurveysResponse, ReturnType<typeof listAvailableProductSurveysQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await listAvailableProductSurveys({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: listAvailableProductSurveysQueryKey(options)
});

/**
 * Permanently dismiss a survey for the current account
 */
export const dismissProductSurveyMutation = (options?: Partial<Options<DismissProductSurveyData>>): UseMutationOptions<unknown, DefaultError, Options<DismissProductSurveyData>> => {
  const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<DismissProductSurveyData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await dismissProductSurvey({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
