...
/**
 * Queue up to 1000 new survey email invitations
 */
export const adminSendSurveyEmailInvitationsMutation = (options?: Partial<Options<AdminSendSurveyEmailInvitationsData>>): UseMutationOptions<AdminSendSurveyEmailInvitationsResponse, DefaultError, Options<AdminSendSurveyEmailInvitationsData>> => {
  const mutationOptions: UseMutationOptions<AdminSendSurveyEmailInvitationsResponse, DefaultError, Options<AdminSendSurveyEmailInvitationsData>> = {
    mutationFn: async (fnOptions) => {
 ...
 */
export const updateNotificationPreferencesMutation = (options?: Partial<Options<UpdateNotificationPreferencesData>>): UseMutationOptions<UpdateNotificationPreferencesResponse, DefaultError, Options<UpdateNotificationPreferencesData>> => {
  const mutationOptions: UseMutationOptions<UpdateNotificationPreferencesResponse, DefaultError, Options<UpdateNotificationPreferencesData>> = {
    mutationFn: async (fnOptions) => {
