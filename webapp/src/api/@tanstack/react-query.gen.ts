 ...
 */
export const adminSendTestEmailMutation = (options?: Partial<Options<AdminSendTestEmailData>>): UseMutationOptions<AdminSendTestEmailResponse, DefaultError, Options<AdminSendTestEmailData>> => {
  const mutationOptions: UseMutationOptions<AdminSendTestEmailResponse, DefaultError, Options<AdminSendTestEmailData>> = {
