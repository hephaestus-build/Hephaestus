...
export const adminGetReleaseQueryKey = (options?: Options<AdminGetReleaseData>) => createQueryKey('adminGetRelease', options, false, ['release-admin']);

/**
 * Get running identity and cached update state
 */
...
/**
 * Check releases, respecting cache and rate-limit backoff
 */
