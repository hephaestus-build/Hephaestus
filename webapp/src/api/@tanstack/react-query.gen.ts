...
export const listUserViewConversationsQueryKey = (options: Options<ListUserViewConversationsData>) => createQueryKey('listUserViewConversations', options, false, ['User view']);

/**
 * View a user's existing private conversations
 */
export const listUserViewConversationsOptions = (options: Options<ListUserViewConversationsData>) => queryOptions<ListUserViewConversationsResponse, DefaultError, ListUserViewConversationsResponse, ReturnType<typeof listUserViewConversationsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
  ...
  queryKey: listUserViewConversationsQueryKey(options)
});

export const listUserViewConversationsInfiniteQueryKey = (options: Options<ListUserViewConversationsData>): QueryKey<Options<ListUserViewConversationsData>> => createQueryKey('listUserViewConversations', options, true);

/**
 * View a user's existing private conversations
 */
export const listUserViewConversationsInfiniteOptions = (options: Options<ListUserViewConversationsData>) => {
  const opts = infiniteQueryOptions<ListUserViewConversationsResponse, DefaultError, InfiniteData<ListUserViewConversationsResponse>, QueryKey<Options<ListUserViewConversationsData>>, number | Pick<QueryKey<Options<ListUserViewConversationsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
      const page: Pick<QueryKey<Options<ListUserViewConversationsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
        query: {
          page: pageParam
        }
      };
    ...
    queryKey: listUserViewConversationsInfiniteQueryKey(options)
  });
  return opts as Omit<typeof opts, 'initialData'>;
};

export const getUserViewConversationQueryKey = (options: Options<GetUserViewConversationData>) => createQueryKey('getUserViewConversation', options, false, ['User view']);

/**
 * Read a user's private conversation without changing it
 */
export const getUserViewConversationOptions = (options: Options<GetUserViewConversationData>) => queryOptions<GetUserViewConversationResponse, DefaultError, GetUserViewConversationResponse, ReturnType<typeof getUserViewConversationQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
  ...
  queryKey: getUserViewConversationQueryKey(options)
});

export const getUserPracticeViewQueryKey = (options: Options<GetUserPracticeViewData>) => createQueryKey('getUserPracticeView', options, false, ['User view']);

/**
 * View a user's existing private practice profile without signing in as them
 */
export const getUserPracticeViewOptions = (options: Options<GetUserPracticeViewData>) => queryOptions<GetUserPracticeViewResponse, DefaultError, GetUserPracticeViewResponse, ReturnType<typeof getUserPracticeViewQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getUserPracticeView({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getUserPracticeViewQueryKey(options)
});

export const listUserViewRunsQueryKey = (options: Options<ListUserViewRunsData>) => createQueryKey('listUserViewRuns', options, false, ['User view']);

/**
 * View a user's private practice review history
 */
export const listUserViewRunsOptions = (options: Options<ListUserViewRunsData>) => queryOptions<ListUserViewRunsResponse, DefaultError, ListUserViewRunsResponse, ReturnType<typeof listUserViewRunsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
  ...
  queryKey: listUserViewRunsQueryKey(options)
});

export const listUserViewRunsInfiniteQueryKey = (options: Options<ListUserViewRunsData>): QueryKey<Options<ListUserViewRunsData>> => createQueryKey('listUserViewRuns', options, true);

/**
 * View a user's private practice review history
 */
export const listUserViewRunsInfiniteOptions = (options: Options<ListUserViewRunsData>) => {
  const opts = infiniteQueryOptions<ListUserViewRunsResponse, DefaultError, InfiniteData<ListUserViewRunsResponse>, QueryKey<Options<ListUserViewRunsData>>, number | Pick<QueryKey<Options<ListUserViewRunsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
      const page: Pick<QueryKey<Options<ListUserViewRunsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
        query: {
          page: pageParam
        }
      };
    ...
    queryKey: listUserViewRunsInfiniteQueryKey(options)
  });
  return opts as Omit<typeof opts, 'initialData'>;
};

export const getUserViewTrendQueryKey = (options: Options<GetUserViewTrendData>) => createQueryKey('getUserViewTrend', options, false, ['User view']);

/**
 * View a user's private practice group trend
 */
export const getUserViewTrendOptions = (options: Options<GetUserViewTrendData>) => queryOptions<GetUserViewTrendResponse, DefaultError, GetUserViewTrendResponse, ReturnType<typeof getUserViewTrendQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
  ...
  queryKey: getUserViewTrendQueryKey(options)
});

export const getUserViewObservationQueryKey = (options: Options<GetUserViewObservationData>) => createQueryKey('getUserViewObservation', options, false, ['User view']);

/**
 * View a user's private observation and feedback
 */
export const getUserViewObservationOptions = (options: Options<GetUserViewObservationData>) => queryOptions<GetUserViewObservationResponse, DefaultError, GetUserViewObservationResponse, ReturnType<typeof getUserViewObservationQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
  ...
  queryKey: getUserViewObservationQueryKey(options)
});
