...
/**
 * Pause or resume a product survey
 */
export const adminUpdateProductSurveyStatusMutation = (options?: Partial<Options<AdminUpdateProductSurveyStatusData>>): UseMutationOptions<AdminUpdateProductSurveyStatusResponse, DefaultError, Options<AdminUpdateProductSurveyStatusData>> => {
  const mutationOptions: UseMutationOptions<AdminUpdateProductSurveyStatusResponse, DefaultError, Options<AdminUpdateProductSurveyStatusData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await adminUpdateProductSurveyStatus({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Undo a survey dismissal without changing a submitted response
 */
export const restoreProductSurveyMutation = (options?: Partial<Options<RestoreProductSurveyData>>): UseMutationOptions<unknown, DefaultError, Options<RestoreProductSurveyData>> => {
  const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<RestoreProductSurveyData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await restoreProductSurvey({
        ...options,
        ...fnOptions,
        throwOnError: true
      });
...
/**
 * Dismiss a survey for the current account
 */
