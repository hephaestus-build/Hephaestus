...
export const getExecutionArchiveQueryKey = (options: Options<GetExecutionArchiveData>) => createQueryKey('getExecutionArchive', options, false, ['Agent Jobs']);

/**
 * List retained private execution artifacts
 */
export const getExecutionArchiveOptions = (options: Options<GetExecutionArchiveData>) => queryOptions<GetExecutionArchiveResponse, DefaultError, GetExecutionArchiveResponse, ReturnType<typeof getExecutionArchiveQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getExecutionArchive({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getExecutionArchiveQueryKey(options)
});

export const getExecutionArtifactQueryKey = (options: Options<GetExecutionArtifactData>) => createQueryKey('getExecutionArtifact', options, false, ['Agent Jobs']);

/**
 * Read a retained private execution artifact
 */
export const getExecutionArtifactOptions = (options: Options<GetExecutionArtifactData>) => queryOptions<GetExecutionArtifactResponse, DefaultError, GetExecutionArtifactResponse, ReturnType<typeof getExecutionArtifactQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getExecutionArtifact({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getExecutionArtifactQueryKey(options)
});
