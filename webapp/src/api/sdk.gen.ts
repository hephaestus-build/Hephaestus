 ...
 */
export const adminSendTestEmail = <ThrowOnError extends boolean = false>(options?: Options<AdminSendTestEmailData, ThrowOnError>): RequestResult<AdminSendTestEmailResponses, unknown, ThrowOnError> => (options?.client ?? client).post<AdminSendTestEmailResponses, unknown, ThrowOnError>({
  security: [{ scheme: 'bearer', type: 'http' }],
