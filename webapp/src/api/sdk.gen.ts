 ...
 */
export const restoreProductSurvey = <ThrowOnError extends boolean = false>(options: Options<RestoreProductSurveyData, ThrowOnError>): RequestResult<RestoreProductSurveyResponses, unknown, ThrowOnError> => (options.client ?? client).delete<RestoreProductSurveyResponses, unknown, ThrowOnError>({
  security: [{ scheme: 'bearer', type: 'http' }],
