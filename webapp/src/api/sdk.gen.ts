 ...
 */
export const updateNotificationPreferences = <ThrowOnError extends boolean = false>(options: Options<UpdateNotificationPreferencesData, ThrowOnError>): RequestResult<UpdateNotificationPreferencesResponses, unknown, ThrowOnError> => (options.client ?? client).put<UpdateNotificationPreferencesResponses, unknown, ThrowOnError>({
  security: [{ scheme: 'bearer', type: 'http' }],
  url: '/user/notification-preferences',
  ...options,
  headers: {
