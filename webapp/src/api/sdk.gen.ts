 ...
 */
export const getExecutionArchive = <ThrowOnError extends boolean = false>(options: Options<GetExecutionArchiveData, ThrowOnError>): RequestResult<GetExecutionArchiveResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetExecutionArchiveResponses, unknown, ThrowOnError>({
  responseTransformer: getExecutionArchiveResponseTransformer,
  security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getExecutionArtifact = <ThrowOnError extends boolean = false>(options: Options<GetExecutionArtifactData, ThrowOnError>): RequestResult<GetExecutionArtifactResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetExecutionArtifactResponses, unknown, ThrowOnError>({
  security: [{ scheme: 'bearer', type: 'http' }],
