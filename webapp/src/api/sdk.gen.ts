 ...
 */
export const adminUpdateProductSurveyStatus = <ThrowOnError extends boolean = false>(options: Options<AdminUpdateProductSurveyStatusData, ThrowOnError>): RequestResult<AdminUpdateProductSurveyStatusResponses, unknown, ThrowOnError> => (options.client ?? client).patch<AdminUpdateProductSurveyStatusResponses, unknown, ThrowOnError>({
  responseTransformer: adminUpdateProductSurveyStatusResponseTransformer,
  security: [{ scheme: 'bearer', type: 'http' }],
